        ...
        <div className='mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8'>
          {laptops.map((laptop) => (
            <div key={laptop.key} className='group relative'>
              ...
              >
                <img src={laptop.image} alt={laptop.name} className=' w-full object-cover object-center' />
              </div>
              <div className='mt-4 flex justify-between'>
                ...
                <div className='flex items-center flex-col'>
                  <button onClick={() => handleAddToBasket(laptop.key)} className='mt-2 text-sm font-medium text-white bg-black px-3 py-1 rounded-md hover:bg-gray-900'>
                    Add to Cart
                  </button>
                </div>
              </div>
          ...
          <div className='relative w-full max-w-3xl p-4 mx-auto my-12'>
            ...
            <div className='relative bg-white rounded-lg shadow-xl flex flex-col lg:flex-row'>
              ...
              <div className='flex-none w-full lg:w-1/2'>
                <img src={selectedLaptop.image} alt={selectedLaptop.name} className='h-full w-full object-cover object-center' />
              </div>
              {/* Laptop Details */}
