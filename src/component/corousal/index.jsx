      ...
      <Slider ref={sliderRef} {...settings}>
        {carouselData.map((item, index) => (
          <div key={index} className='carousel-item'>
            ...
            <p className='text-center text-white font-bold text-base bg-black py-1 px-2 rounded-lg shadow-lg border-2 border-primary inline-block'>{item.model}</p>
          </div>
        ))}
      </Slider>
          ...
          <div className='relative w-full max-w-3xl p-4 mx-auto my-12'>
            ...
            <div className='relative bg-white rounded-lg shadow-xl flex flex-col lg:flex-row'>
              ...
              <div className='p-8 w-full lg:w-1/2'>
                ...
                <p className='text-gray-700 font-baloo font-semibold'>${selectedProduct.price}</p>
                {/* Add to Cart Button */}
                <button
