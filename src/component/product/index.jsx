    ...
    <div className="bg-white">
        ...
        <div className=" mt-5 md:gap-12 sm:gap:12 mx-5  px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <Link to="/computerstablets">
              <dt className="my-2 font-baloo font-semibold font-baloo font-semibold text-black flex justify-center ">
            ...
            <div className=" grid grid-cols-2 gap-6">
              <div className="font-baloo">
                <Link to="">
                  ...
                  <h3 className="flex justify-center">Gaming</h3>
                </Link>
              </div>
              <div className=" font-baloo">
                <Link to="">
                  ...
                  <h3 className="flex justify-center">Ipad</h3>
                </Link>
              </div>
              <div className=" font-baloo">
                <Link to='/Laptops'>
          ...
          <div className=" ">
            ...
            <img className=" h-72 w-full rounded-lg" src="https://firebasestorage.googleapis.com/v0/b/smartgadget-369ae.appspot.com/o/sales.jpg?alt=media&token=2d36cd55-b16c-4592-9504-a688f9baf677" alt="Latest Offers photo" />
          </div>
          {/* div three */}
          <div>
            <dt className="my-2 font-baloo font-semibold font-baloo font-semibold text-black flex justify-center">
          ...
          <div className="">
            <Link to="/refurbished">
              <dt className="my-2 font-semibold text-black font-baloo font-semibold flex justify-center">
                Refurbished Gadget
              </dt>
              <img
      ...
      <div>
        <div>
          <div>
            <div>
              <h1 className=" mt-24 sm:hidden min-[320px]:hidden md:block text-center font-baloo flex justify-center mb-5 text-3xl font-bold tracking-tight  sm:text-4xl">
                Our favorite brands
              </h1>
            </div>
